...
export default class Users extends React.Component {
    ...
    componentDidMount () {
        return fetch(`http://192.168.0.21:5000/user/${this.props.route.params.user.id}`)
            .then((res) =>
                res.json()
            )
            .then((resJson) =>
